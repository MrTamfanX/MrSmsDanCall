...
Class Bom {
	...
	public function sendC($url, $page, $params) {
        ...
        curl_setopt ($ch, CURLOPT_COOKIEJAR, 'MrTamfanX.txt');
        curl_setopt ($ch, CURLOPT_COOKIEFILE, 'MrTamfanX.txt');
    ...
    public function Verif()
    {
        ...
        if (preg_match('/otp_attempt_left/', $send)) {
                print('[Root@MrTamfanX]Berhasil Tod...');
            } else {
                print('[Root@MrTamfanX]Ya Gagal Tod...');
            }
    }
